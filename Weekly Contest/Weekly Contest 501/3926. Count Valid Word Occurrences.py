"""
3926. Count Valid Word Occurrences - Medium
...
if __name__ == "__main__":
    ...
    # Example 1
    print(sol.countWordOccurrences(["hello wor", "ld hello"], ["hello", "world", "wor"]))  # [2, 1, 0]

    # Example 2
    print(sol.countWordOccurrences(["a--b a-", "-c"], ["a", "b", "c"]))  # [2, 1, 1]

    # Example 3
    print(sol.countWordOccurrences(["hello"], ["hello", "ell"]))  # [1, 0]
