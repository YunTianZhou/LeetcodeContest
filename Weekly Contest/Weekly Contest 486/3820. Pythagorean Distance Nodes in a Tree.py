...
class Solution:
    def specialNodes(self, n: int, edges: List[List[int]], x: int, y: int, z: int) -> int:
        ...
        return sum(2 * max(a, b, c) ** 2 == a * a + b * b + c * c for a, b, c in zip(dx, dy, dz))
...
if __name__ == "__main__":
    ...
    # Example 1
    print(sol.specialNodes(4, [[0, 1], [0, 2], [0, 3]], 1, 2, 3))  # 3

    # Example 2
    print(sol.specialNodes(4, [[0, 1], [1, 2], [2, 3]], 0, 3, 2))  # 0

    # Example 3
    print(sol.specialNodes(4, [[0, 1], [1, 2], [1, 3]], 1, 3, 0))  # 1
