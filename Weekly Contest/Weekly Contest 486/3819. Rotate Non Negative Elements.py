...
class Solution:
    def rotateElements(self, nums: List[int], k: int) -> List[int]:
        values = [x for i, x in enumerate(nums) if x >= 0]
...
if __name__ == "__main__":
    ...
    # Example 1
    print(sol.rotateElements([1, -2, 3, -4], 3))  # [3, -2, 1, -4]

    # Example 2
    print(sol.rotateElements([-3, -2, 7], 1))  # [-3, -2, 7]

    # Example 3
    print(sol.rotateElements([5, 4, -9, 6], 2))  # [6, 5, -9, 4]
