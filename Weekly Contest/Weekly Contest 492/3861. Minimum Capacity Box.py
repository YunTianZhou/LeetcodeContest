...
class Solution:
    def minimumIndex(self, capacity: list[int], itemSize: int) -> int:
        return min(((c, i) for i, c in enumerate(capacity) if c >= itemSize), default=(inf, -1))[1]
...
if __name__ == "__main__":
    ...
    # Example 1
    print(sol.minimumIndex([1, 5, 3, 7], 3))  # 2

    # Example 2
    print(sol.minimumIndex([3, 5, 4, 3], 2))  # 0

    # Example 3
    print(sol.minimumIndex([4], 5))  # -1
