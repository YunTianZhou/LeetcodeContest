...
class Solution:
    def findDisappearedNumbers(self, nums: list[int], lower: int, upper: int) -> list[list[int]]:
        ...
        return [[x + 1, y - 1] for x, y in pairwise(nums) if x + 1 < y]
...
if __name__ == "__main__":
    ...
    # Example 1
    print(sol.findDisappearedNumbers([3, 9, 7], 1, 12))  # [[1, 2], [4, 6], [8, 8], [10, 12]]

    # Example 2
    print(sol.findDisappearedNumbers([1, 1], 5, 7))  # [[5, 7]]

    # Example 3
    print(sol.findDisappearedNumbers([2, 3, 5], 2, 3))  # []
