...
if __name__ == "__main__":
    ...
    # Example 1
    print(sol.reverseWords("cat and mice"))  # "cat dna mice"

    # Example 2
    print(sol.reverseWords("book is nice"))  # "book is ecin"

    # Example 3
    print(sol.reverseWords("banana healthy"))  # "banana healthy"
