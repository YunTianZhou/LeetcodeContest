...
[graph1](https://assets.leetcode.com/uploads/2026/03/14/g41f.png)
...
[graph2](https://assets.leetcode.com/uploads/2026/03/14/g42f.png)
...
if __name__ == "__main__":
    ...
    # Example 1
    print(sol.findDegrees([[0, 1, 1], [1, 0, 1], [1, 1, 0]]))  # [2, 2, 2]

    # Example 2
    print(sol.findDegrees([[0, 1, 0], [1, 0, 0], [0, 0, 0]]))  # [1, 1, 0]

    # Example 3
    print(sol.findDegrees([[0]]))  # [0]
