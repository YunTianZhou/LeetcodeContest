...
class Solution:
    def minPrice(self, prices: list[int], discounts: list[int]) -> float:
        ...
        return sum(prices) - sum(x * d for x, d in zip(prices, discounts)) / 100
...
if __name__ == "__main__":
    ...
    # Example 1
    print(sol.minPrice([10, 30, 21], [50, 60]))  # 32.50000

    # Example 2
    print(sol.minPrice([100, 70], [10, 40, 50]))  # 92.00000

    # Example 3
    print(sol.minPrice([7, 3, 9], [100, 100]))  # 3.00000
