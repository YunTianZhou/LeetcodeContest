...
[graph1](https://assets.leetcode.com/uploads/2026/06/09/t1.png)
...
[graph2](https://assets.leetcode.com/uploads/2026/06/09/t2.png)
...
if __name__ == "__main__":
    ...
    # Example 1
    print(sol.weightedSum([-1, 0, 0, 0, 2, 2], [5, 2, 3, 1, 4, 6]))  # 37

    # Example 2
    print(sol.weightedSum([-1, 0, 1, 2], [1, 2, 3, 4]))  # 20
