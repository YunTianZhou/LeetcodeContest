...
if __name__ == "__main__":
    ...
    # Example 1
    print(sol.prefixConnected(["apple", "apply", "banana", "bandit"], 2))  # 2

    # Example 2
    print(sol.prefixConnected(["car", "cat", "cartoon"], 3))  # 1

    # Example 3
    print(sol.prefixConnected(["bat", "dog", "dog", "doggy", "bat"], 3))  # 2
