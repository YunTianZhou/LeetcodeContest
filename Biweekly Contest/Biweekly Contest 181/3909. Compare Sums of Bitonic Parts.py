"""
3909. Compare Sums of Bitonic Parts - Medium
...
if __name__ == "__main__":
    ...
    # Example 1
    print(sol.compareBitonicSums([1, 3, 2, 1]))  # 1

    # Example 2
    print(sol.compareBitonicSums([2, 4, 5, 2]))  # 0

    # Example 3
    print(sol.compareBitonicSums([1, 2, 4, 3]))  # -1
