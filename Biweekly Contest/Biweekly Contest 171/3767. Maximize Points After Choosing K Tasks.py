...
class Solution:
    def maxPoints(self, technique1: List[int], technique2: List[int], k: int) -> int:
        ...
        change = [y - x for x, y in zip(technique1, technique2)]
        return sum(technique1) + sum(max(0, x) for x in nlargest(n - k, change))
...
if __name__ == "__main__":
    ...
    # Example 1
    print(sol.maxPoints([5, 2, 10], [10, 3, 8], 2))  # 22

    # Example 2
    print(sol.maxPoints([10, 20, 30], [5, 15, 25], 2))  # 60

    # Example 3
    print(sol.maxPoints([1, 2, 3], [4, 5, 6], 0))  # 15
