...
class Solution:
    def mergeCharacters(self, s: str, k: int) -> str:
        ...
        for i, c in enumerate(s):
            if c in last and len(ans) - last[c] < k:
                continue
            ans.append(c)
            last[c] = len(ans)
        return "".join(ans)
...
if __name__ == "__main__":
    ...
    # Example 1
    print(sol.mergeCharacters("abca", 3))  # "abc"

    # Example 2
    print(sol.mergeCharacters("aabca", 2))  # "abca"

    # Example 3
    print(sol.mergeCharacters("yybyzybz", 2))  # "ybzybz"
